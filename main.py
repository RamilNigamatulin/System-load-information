...
def statistics():  # pragma: no cover
...
def update_labels():  # pragma: no cover
    global recording
...
def update_timer():  # pragma: no cover
    if recording:
...
def click_button():  # pragma: no cover
...
def create_gui():  # pragma: no cover
    global root, label_1, label_2, label_3, label_4, timer_label, menu, clear_button, btn, recording, start_time
